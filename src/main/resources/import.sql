...
INSERT INTO brinquedo (nome, marca, categoria_id, descricao, idade_ideal, imagem_principal, preco, destaque) VALUES ('Carrinho de Controle Remoto Bem 10', 'Candide', 1, 'Veículo de rádio controle de 7 funções. Pronto para brincar. Utiliza 4 pilhas AA no carro e 1 bateria 9V no controle (inclusas para demonstração).', '7+', '/imagens/brinquedos/CarroBen10.png', 149.90, true);
...
--Brinquedos Musicais--
INSERT INTO brinquedo (nome, marca, categoria_id, descricao, idade_ideal, imagem_principal, preco, destaque) VALUES ('Mini Piano Infantil', 'MusicFun', 8, 'Mini piano com teclas coloridas e sons realistas. Estimula a criatividade, coordenação e interesse musical das crianças. Feito com material durável e seguro.', '4+', '/imagens/brinquedos/MiniPiano.png', 129.90, true);
INSERT INTO brinquedo (nome, marca, categoria_id, descricao, idade_ideal, imagem_principal, preco, destaque) VALUES ('Conjunto de bateria elétrica', 'ROCKSOCKI', 8, 'A bateria eletrônica Rocksocki vêm com todos os componentes que você precisa para começar: 3 toms, 1 chimbal HI-HA, 1 prato SNARE, 1 prato RIDE, 1 prato CRASH e 2 pedais para o bumbo e chimbal HI-HAT.', '9+', '/imagens/brinquedos/BateriaGuitarHero.png', 349.50, false);
